...
export function Service({ services, UpdateService, DeleteService, LoadServices, AddService, subscriptions,  currentPage, itemsPerPage, totalItems, totalPages  }) {
    ...
    const {
        ...
        TblHead,
        page,
    } = usePaginationTable(currentPage, itemsPerPage, totalItems, totalPages, services, headCells, filterFn);
