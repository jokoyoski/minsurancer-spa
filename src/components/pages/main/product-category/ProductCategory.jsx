...
export function ProductCategory({ categories,
    UpdateProductCategory, AddProductCategory,
    LoadProductCategory, DeleteProductCategory, companyId,
    ...
    } = usePaginationTable(currentPage, itemsPerPage, totalItems, totalPages, categories, headCells, filterFn);
    useEffect(() => {
        var data = {
            page: 1
        }
